...
* Levi-Civita and Kroenecker delta (with appropriate symmetry properties, simplification, and canonicalization)
...
TODO: Probably define a new simplification routine that carries out all the epsilon-delta identities, eliminates Kronecker deltas etc.
